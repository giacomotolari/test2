...
// // initialisiere mein Board
// const arrContainers = new Array(12).fill(4)

// const moveStones = (containerIndexClicked) => {

//   let containerIndex = containerIndexClicked
//   let stones = arrContainers[containerIndex] // get amount of stones on container

//   // remove stones on clicked field...
//   arrContainers[containerIndex] = 0

//   containerIndex++ // move to next field...

//   // loope bis zum Ende des Arrays und starte wieder am Anfang ...
//   while( stones ) {
  
//     // we reached last container => restart index at 0
//     if(containerIndex >= 12) {
//       containerIndex = 0
//     }
  
//     arrContainers[containerIndex]++ // increase stones on next container
//     stones-- // on each round we have one stone less...
//     containerIndex++ // move to next field...
//   }

// }

// const containerIndexClicked = 9

// console.log( arrContainers) // containers at begin

// // let's say I clicked container index 9 (= 10th container on board...)
// moveStones( 9 )
// console.log( arrContainers ) // conainers after move

// // move all stones on container index 0
// moveStones( 0 ) 
